(function($){
    ...
    $(document).ready(function(){
        ...
        $('#toplevel_page_ThemeDashboard').children('ul').children('li.wp-first-item').before('<li><a target="_blank" href="http://arktheme.com/academy/"><span style="color:#32d316;"> &#8594; Ark Academy &#8592; </a></a></li>');
        console.log(' bbb');
