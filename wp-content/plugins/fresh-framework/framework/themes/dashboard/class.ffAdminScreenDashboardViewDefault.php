...
<p>
		...
		<p>
		One License can be active only on one site at any given moment, not more. But the License can be transferred upto 5 times to a different site. Each transfer will automatically deactivate the previous activation. Localhost, different subdomains and TLDs count towards your transfer limit as well.
		</p>
		<p>
		...
		<p>
		Should you need more than 5 transfers, please contact us and we will be more than happy to change the limit for your license manually.
		</p>
