...
/*footer widget text color end*/
/*footer widget link color start*/
...
//));
//$wp_customize->add_control(
//	new WP_Customize_Color_Control($wp_customize,'footer_widget_link_color_control',array(
//		'label' => __('Footer Widget Link Color','hanson'),
//		'section' => 'footer_color_section',
//		'settings' => 'footer_widget_link_color'
//	))
//);
/*footer widget link color end*/
...
$wp_customize->add_setting( 'copyright_text', array(
    'default' => __( 'Copyright 2017 imperial WordPress Theme - by iThemesLab', 'hanson' ),
