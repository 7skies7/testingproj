...
function hanson_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            ...
            'force_activation'   => false,
            'force_deactivation' => false,
            'source'             => get_template_directory().'/inc/plugins/hanson-core.zip',
        ),
        array(
		...
		array(
			'name'               => esc_html__( 'Customizer Export/Import','hanson' ),
		...
		array(
			'name'               => esc_html__( 'Widget Settings Importer/Exporter','hanson' ),
		...
		array(
			'name'               => esc_html__( 'Revolution Slider','hanson' ),
			'slug'               => 'revslider',
			'required'           => true,
			'force_activation'   => false,
			'force_deactivation' => false,
